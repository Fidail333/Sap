  ...
  return (
    <main>
      <Section className="pt-12 md:pt-20">
        <div className="rounded-3xl border border-cyan-200/20 bg-slate-900/60 p-8 md:p-12">
          <h1 className="text-4xl font-semibold md:text-5xl">О компании Sapphire LED</h1>
          <p className="mt-5 max-w-3xl text-slate-300">Sapphire LED — динамично развивающаяся компания, специализирующаяся на поставке высококачественных светодиодных модулей и комплектующих для экранов по всей стране.</p>
        </div>
      </Section>
      ...
      <Section>
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <article className="order-1 rounded-2xl border border-white/10 bg-white/[0.03] p-6 lg:order-2">
